/* @ts-self-types="./mania_pp_wasm.d.ts" */
...
export class Calculator {
    ...
    map_json() {
        ...
        try {
            ...
            wasm.calculator_map_json(retptr, this.__wbg_ptr);
     ...
     * @param {string} osu_text
     * @param {string} mods
     */
    constructor(osu_text, mods) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(osu_text, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(mods, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
            const len1 = WASM_VECTOR_LEN;
            wasm.calculator_new(retptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
     ...
     */
    get objects() {
        const ret = wasm.calculator_objects(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {string}
     */
    price(n320, n300, n200, n100, n50, misses) {
        let deferred2_0;
        let deferred2_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.calculator_price(retptr, this.__wbg_ptr, n320, n300, n200, n100, n50, misses);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
     ...
     */
    set_lazer(lazer) {
        wasm.calculator_set_lazer(this.__wbg_ptr, lazer);
    }
}
 ...
 * @returns {string}
 */
export function price_score(osu_text, mods, n320, n300, n200, n100, n50, misses) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const ptr1 = passStringToWasm0(mods, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
        const len1 = WASM_VECTOR_LEN;
        wasm.price_score(retptr, ptr0, len0, ptr1, len1, n320, n300, n200, n100, n50, misses);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {string}
 */
export function rosu_pp_rev() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.rosu_pp_rev(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('mania_pp_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
